...
const DICT = {
  ko: {
    ...
    paymentCashAwaitingStaff: '직원이 현금 결제를 확인하면 자동으로 다음 단계로 넘어갑니다',
    paymentSumupAppMissingMsg: 'SumUp 앱이 이 기기에 설치되어 있지 않은 것 같습니다. 지정된 결제 단말기에서 다시 시도해주세요.',
  ...
  en: {
    ...
    paymentCashAwaitingStaff: 'Once staff confirm the cash payment, this will move on automatically',
    paymentSumupAppMissingMsg: 'The SumUp app does not seem to be installed on this device. Please try again on the designated payment terminal.',
  ...
  de: {
    ...
    paymentCashAwaitingStaff: 'Sobald das Personal die Barzahlung bestätigt, geht es automatisch weiter',
    paymentSumupAppMissingMsg: 'Die SumUp-App scheint auf diesem Gerät nicht installiert zu sein. Bitte versuchen Sie es am dafür vorgesehenen Zahlungsterminal erneut.',
