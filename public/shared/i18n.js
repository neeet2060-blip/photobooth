...
const DICT = {
  ko: {
    ...
    agreeButton: '동의하고 시작',
    cancelButton: '취소',
    cancelPaidConfirmMsg: '이미 결제하셨습니다. 정말 처음 화면으로 돌아가시겠습니까? (환불은 별도로 처리해야 합니다)',
  ...
  en: {
    ...
    cancelButton: 'Cancel',
    cancelPaidConfirmMsg: 'Payment has already been made. Are you sure you want to go back to the start screen? (Refunds must be handled separately)',
  ...
  de: {
    ...
    cancelPaidConfirmMsg: 'Die Zahlung wurde bereits vorgenommen. Möchten Sie wirklich zum Startbildschirm zurückkehren? (Rückerstattungen müssen separat erfolgen)',
